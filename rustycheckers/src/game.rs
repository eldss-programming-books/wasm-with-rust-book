...
impl GameEngine {
    ...
    // Black pieces in row 0 or White piece is row 7 are crowned
...
// Below tests copied directly from example code
#[cfg(test)]
mod test {
