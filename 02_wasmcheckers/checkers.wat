...
(import "events" "piecemoved"
    (func $notify_piecemoved (param $fromX i32) (param $toX i32) (param $toY i32)))
...
;; At the end of a turn, swith turn owner to the other player
...
(func $isPlayersTurn (param $player i32) (result i32)
    (i32.gt_s
        ;; If different, bitwise and becomes 0
...
;; We crown black pieces in row 0, white piece in row 7
...
(func $do_move (param $fromX i32) (param $fromY i32)
    ...
    ;; Was causing errors
    ;; This being commented may also be causing issues with the final output
    ;;(i32.const 1)
)
